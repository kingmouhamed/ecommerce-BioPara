        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center py-20">
          ...
          <div className="space-y-8 lg:order-2">
            ...
            <div className="inline-flex items-center gap-2 bg-[var(--color-accent)]/10 text-[var(--color-accent)] px-4 py-2 rounded-full text-sm font-semibold">
              ...
              <span>موثوق في أكثر من 50 دولة</span>
            </div>

            {/* Main Headline */}
            <div className="space-y-4">
              <h1 className="text-display text-gradient-primary text-right">
                العافية الطبيعية الفاخرة
                <span className="block text-[var(--color-accent)]">تصل لكل العالم</span>
              </h1>
              <p className="text-body text-[var(--color-text-secondary)] leading-relaxed max-w-lg text-right">
                استمتع بأجود منتجات العافية الطبيعية من المغرب، الموثوقة من قبل أكثر من مليون عميل حول العالم. 
                من زيت الأرغان الفاخر إلى العلاجات العشبية التقليدية، نقدم أفضل الطبيعة لباب منزلك.
              </p>
            </div>
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <div className="text-center space-y-4">
                    ...
                    <div className="space-y-2">
                      <h3 className="text-xl font-bold text-[var(--color-primary)]">زيت الأرغان الفاخر</h3>
                      <p className="text-[var(--color-text-secondary)]">100% نقي • عضوي • معصور على البارد</p>
                      ...
                      <div className="text-2xl font-bold text-[var(--color-accent)]">249.99 درهم</div>
                    </div>
                  </div>
                </div>
              </div>
