  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
      ...
      <div className="p-4" dir="rtl">
        <div className="text-sm text-gray-500 mb-1 line-clamp-1">{product.origin || 'أعشاب طبية'}</div>
        <h3 className="font-semibold text-gray-900 leading-snug line-clamp-2 min-h-[2.75rem]">{product.title}</h3>

        {product.benefit && <div className="text-xs text-gray-600 mt-2 line-clamp-2">{product.benefit}</div>}
