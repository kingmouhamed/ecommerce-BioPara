      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            في شركة <strong>BioPara المغرب</strong>، نحن ملتزمون بحماية خصوصيتك وبياناتك الشخصية. توضح هذه السياسة كيفية جمع واستخدام وحماية معلوماتك عند استخدام موقعنا الإلكتروني وخدماتنا.
          </p>
        </div>
