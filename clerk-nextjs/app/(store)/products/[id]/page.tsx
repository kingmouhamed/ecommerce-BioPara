                ...
                <div className="flex gap-2 overflow-x-auto pb-2">
                  {product.images.map((image: string, index: number) => (
                    <button
                      ...
                      className={`flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden border-2 ${selectedImage === index ? 'border-emerald-600' : 'border-gray-200'
                        }`}
                    >
                      <Image
                        src={image}
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-2 px-6 py-3 rounded-lg font-medium transition-all ${!product.inStock
                ...
                <div className="flex gap-8">
                  {['description', 'benefits', 'usage', 'ingredients'].map((tab) => (
                    <button
                      ...
                      className={`py-4 border-b-2 font-medium transition-colors ${activeTab === tab
