...
export default function Home() {
  ...
  const customerReviews = [
    { id: 1, name: "فاطمة أحمد", rating: 5, comment: "منتجات ممتازة وجودة عالية. استخدمت زيت الأرغان وكانت النتائج مذهلة!", productImage: "/images/medicinal-oils/argan-oil.jpg" },
    { id: 2, name: "محمد العلي", rating: 5, comment: "خدمة توصيل سريعة ومنتجات أصلية 100%. أنصح بالتعامل معهم", productImage: "/images/medicinal-herbs/ginger-herb.jpg" },
    { id: 3, name: "نورة سعيد", rating: 5, comment: "الأعشاب الطبية ساعدتني كثيراً في تحسين صحتي. شكراً لكم", productImage: "/images/medicinal-herbs/camomile-herb.jpg" }
  ];

  const blogArticles = [
    { id: 1, title: "فوائد زيت الأرغان للبشرة", date: "15 يناير 2024", image: "/images/medicinal-oils/argan-oil.jpg" },
    { id: 2, title: "كيف تقوي مناعتك طبيعياً", date: "10 يناير 2024", image: "/images/dietary-supplements/vitamin-d3-k2.jpg" },
    { id: 3, title: "فن تحضير شاي الأعشاب", date: "5 يناير 2024", image: "/images/medicinal-herbs/mint-herb.jpg" }
  ];
            ...
            <div className="flex items-center justify-center gap-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl">
                {customerReviews.map((review, index) => (
                  <div
                    key={review.id}
                    className={`bg-white rounded-lg p-6 shadow-md transition-all duration-300 ${index === currentReviewIndex ? 'scale-105 shadow-xl' : 'opacity-50'
                      }`}
                  >
