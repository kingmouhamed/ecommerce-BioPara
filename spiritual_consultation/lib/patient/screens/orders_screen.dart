  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: ordersAsync.when(
        ...
        error: (err, stack) => Center(child: Text('خطأ ÙÙŠ تحميل الطلبات: $err')),
      ),
    );
  }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('لا ØªÙˆجد طلبات Ø³Ø§Ø¨Ù‚ة', style: GoogleFonts.tajawal(fontSize: 18, color: Colors.grey)),
        ],
      ),
    );
  }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text('${order.totalPrice} درهم', style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 18, color: Color(0xFF0D6E6E))),
              ],
            ),
          ],
        ),
